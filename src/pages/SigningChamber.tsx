...
const mainAgreement = [
  "《TRIVA 商家入驻合作协议》",
  "本协议由 TRIVA（以下简称「平台」）与入驻商家（以下简称「商家」）共同签署。商家确认已充分阅读并理解本协议全部条款。",
  ...
  "第三条 品质标准：商家须严格遵守平台统一的品控规范与包材标准，确保每一杯出品符合 TRIVA 品牌质量要求。",
...
const attachmentTabs = [
  ...
  },
  {
    ...
    threeParty: true,
    paragraphs: [
      "本协议由 TRIVA 平台、TRIVA 供应链公司与入驻商家三方共同签署。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "三、扶持政策最终解释权归 TRIVA 平台所有，具体细则以后台同步为准。",
